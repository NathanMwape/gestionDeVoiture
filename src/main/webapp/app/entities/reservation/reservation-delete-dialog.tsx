...
export const ReservationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reservaionApp.reservation.delete.question">
        <Translate contentKey="reservaionApp.reservation.delete.question" interpolate={{ id: reservationEntity.id }}>
