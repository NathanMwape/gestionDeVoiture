...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GESTIONFLOTTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GESTIONFLOTTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GESTIONFLOTTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GESTIONFLOTTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GESTIONFLOTTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GESTIONFLOTTE actions', async () => {
      const expectedActions = [
        {
