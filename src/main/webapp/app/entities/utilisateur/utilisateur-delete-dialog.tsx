...
export const UtilisateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reservaionApp.utilisateur.delete.question">
        <Translate contentKey="reservaionApp.utilisateur.delete.question" interpolate={{ id: utilisateurEntity.id }}>
