...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './voiture.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOITURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VOITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VOITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VOITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VOITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VOITURE actions', async () => {
      const expectedActions = [
        {
